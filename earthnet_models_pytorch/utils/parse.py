...
def parse_setting(setting_file, track=None):
    ...
    gpus = (
        setting_dict["Trainer"]["gpus"]
        if "gpus" in setting_dict["Trainer"]
        else setting_dict["Trainer"]["devices"]
    )
    ...
    if setting_dict["Architecture"] in [
        "channel-u-net",
        "local-rnn",
        "rnn",
        "context-convlstm",
    ...
    setting_dict["Task"]["loss"]["context_length"] = setting_dict["Task"][
        "context_length"
    ]
    setting_dict["Task"]["loss"]["target_length"] = setting_dict["Task"][
        "target_length"
    ]
    ...
    setting_dict["Task"]["metric_kwargs"]["context_length"] = setting_dict["Task"][
        "context_length"
    ]
    setting_dict["Task"]["metric_kwargs"]["target_length"] = setting_dict["Task"][
        "target_length"
    ]

    if "model_shedules" in setting_dict["Task"]["metric_kwargs"]:
        setting_dict["Task"]["metric_kwargs"]["shedulers"] = setting_dict["Task"][
            "metric_kwargs"
        ]["model_shedules"]
