...
from earthnet_models_pytorch.setting.en21x_data_old import EarthNet2021XOldDataModule,EarthNet2021XpxOldDataModule
...
SETTINGS = ["en21-std", "en21-veg", "europe-veg", "en21x", "en21xold","en21x-pxold", "en22"]
METRICS = {"en21-std": EarthNetScore, "en21-veg": RMSEVegScore, "en21x": NNSEVeg, "en21xold": RMSE_ens21x,"en21x-pxold": RMSE_ens21x, "en22": RMSE_ens22}
DATASETS = {"en21-std": EarthNet2021DataModule, "en21-veg": EarthNet2021DataModule, "en21xold": EarthNet2021XOldDataModule, "en21x": EarthNet2021XDataModule, "en21x-pxold": EarthNet2021XpxOldDataModule, "en22": EarthNet2022DataModule}
